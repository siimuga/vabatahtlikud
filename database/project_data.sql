...
INSERT INTO public.contact (id, first_name, last_name, sex, email) VALUES (DEFAULT, 'Mart', 'Tamm', 'M', 'asdas@gmail.com');
INSERT INTO public.contact (id, first_name, last_name, sex, email) VALUES (DEFAULT, 'Gulba', 'Hammas', 'N', 'abudhabi@hot.ru');
...
INSERT INTO public.location (id, address, longtitude, latitude, county_id) VALUES (DEFAULT, 'Susal 998', null, null, 5);
INSERT INTO public.location (id, address, longtitude, latitude, county_id) VALUES (DEFAULT, 'Eras 998', null, null, 1);
INSERT INTO public.location (id, address, longtitude, latitude, county_id) VALUES (DEFAULT, 'Velasd 55', null, null, 11);

INSERT INTO public.event (id, event_name, start_date, end_date, volunteers_required, category_id, language_id, link, location_id, status, user_id) VALUES (DEFAULT, 'Murutraktor', '2022-09-16', '2022-09-17', 10, 1, 1, null, 1, 'e', 2);
INSERT INTO public.event (id, event_name, start_date, end_date, volunteers_required, category_id, language_id, link, location_id, status, user_id) VALUES (DEFAULT, 'Huumor', '2021-09-29', '2021-09-30', 100, 2, 2, null, 2, 'e', 4);
...
INSERT INTO public.event (id, event_name, start_date, end_date, volunteers_required, category_id, language_id, link, location_id, status, user_id) VALUES (DEFAULT, 'Proov', '2023-09-02', '2023-09-30', 3, 4, 1, null, 2, DEFAULT, 3);
INSERT INTO public.event (id, event_name, start_date, end_date, volunteers_required, category_id, language_id, link, location_id, status, user_id) VALUES (DEFAULT, 'Kallas', '2022-11-25', '2022-12-06', 71, 1, 1, null, 2, 'c', 3);
INSERT INTO public.event (id, event_name, start_date, end_date, volunteers_required, category_id, language_id, link, location_id, status, user_id) VALUES (DEFAULT, 'Rullik', '2022-12-22', '2022-12-26', 500, 2, 1, null, 3, 'c', 3);

INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Tere', DEFAULT, 1);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Mängima', DEFAULT, 1);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Marssima', DEFAULT, 2);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Koolja', DEFAULT, 3);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Seda', DEFAULT, 4);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Toda', DEFAULT, 5);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Wer', DEFAULT, 5);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Man', DEFAULT, 3);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'WH', DEFAULT, 3);
INSERT INTO public.task (id, name, status, event_id) VALUES (DEFAULT, 'Poolik', DEFAULT, 2);
