...
-- Last modification date: 2022-09-13 19:48:01.606
...
-- foreign keys
-- Reference: event_additional_info (table: event)
ALTER TABLE event ADD CONSTRAINT event_additional_info
    FOREIGN KEY (additional_info_id)
    REFERENCES additional_info (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
-- Reference: event_task (table: event)
ALTER TABLE event ADD CONSTRAINT event_task
    FOREIGN KEY (task_id)
    REFERENCES task (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
