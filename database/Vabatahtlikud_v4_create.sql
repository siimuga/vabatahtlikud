...
DROP SCHEMA public_vaba CASCADE;
-- Loob uue public schema vajalikud õigused
CREATE SCHEMA public_vaba
-- taastab vajalikud andmebaasi õigused
    GRANT ALL ON SCHEMA public_vaba TO postgres;
GRANT ALL ON SCHEMA public_vaba TO PUBLIC;
...
SET search_path TO public_vaba;
...
ALTER TABLE additional_info
    ADD CONSTRAINT additional_info_event
...
ALTER TABLE event_date
    ADD CONSTRAINT event_date_event
        FOREIGN KEY (event_id)
            REFERENCES event (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE location
    ADD CONSTRAINT location_county
...
ALTER TABLE picture_data
    ADD CONSTRAINT picture_data_event
        FOREIGN KEY (event_id)
            REFERENCES event (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE volunteer
    ADD CONSTRAINT volunteer_event
        FOREIGN KEY (event_id)
            REFERENCES event (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE volunteer_event_date
    ADD CONSTRAINT volunteer_event_date_event_date
...
ALTER TABLE volunteer_event_date
    ADD CONSTRAINT volunteer_event_date_volunteer
...
ALTER TABLE volunteer_task
    ADD CONSTRAINT volunteer_task_task
        FOREIGN KEY (task_id)
            REFERENCES task (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE volunteer_task
    ADD CONSTRAINT volunteer_task_volunteer
        FOREIGN KEY (volunteer_id)
            REFERENCES volunteer (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
