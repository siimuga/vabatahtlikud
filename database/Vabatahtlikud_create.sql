...
-- Last modification date: 2022-09-11 12:10:40.029
...
(
    id serial NOT NULL,
    CONSTRAINT event_register_pk PRIMARY KEY (id)
);
...
-- foreign keys
-- Reference: additional_info_event_register (table: additional_info)
ALTER TABLE additional_info
    ADD CONSTRAINT event_register
...
ALTER TABLE event
    ADD CONSTRAINT event_event_register
        FOREIGN KEY (event_register_id)
            REFERENCES event_register (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE task
    ADD CONSTRAINT task_event_register
        FOREIGN KEY (event_register_id)
            REFERENCES event_register (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
